...
void init()
{
    ...
    fillColor = sf::Color::Black;
     if (!font.loadFromFile("/home/alex/STM32Project/STM32-Image-Streamer/Server/Src/intro.ttf")) {
...
void render_process()
{
    ...
    {   
        ...
        for (size_t i = 0; i < pixels.size(); i++) {
             window.draw(&pixels[i], sizeof(pixels[i]), sf::Points);  // Отрисовка одного пикселя
        }
